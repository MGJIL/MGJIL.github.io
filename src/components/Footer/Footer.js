	...
	return (
        <div className="Footer">
            <div className="Equipededev">
                <div className="Maxime box-dev">
                    ...
                    <div className="SocialBox">
                        ...
                        <a href="https://www.instagram.com/costamaxim_cvl/" className="fa-instagram"><img className="fa fa-image" alt="instagram" src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/instagram.svg" /></a>
                    </div>
                </div>
                <div className="Nolan box-dev">
                    ...
                    <div className="SocialBox">
                        ...
                        <a href="https://www.instagram.com/arkanyota/" className="fa-instagram"><img className="fa fa-image" alt="instagram" src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/instagram.svg" /></a>
                    </div>
                </div>
            ...
            <div  className="IcoFooter">
                ...
                <a href="https://github.com/ARKANYOTA/gamejaminterlyceeheroku" className="SourceCode">
